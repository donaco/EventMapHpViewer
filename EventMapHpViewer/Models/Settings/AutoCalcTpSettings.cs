    ...
    class AutoCalcTpSettings : EventMapHpViewer.Infrastructure.Mvvm.Notifier
    {
        ...
        private static AutoCalcTpSettings CreateDefault()
        {
            ...
            var slotitemTp = new[]
            {
                ...
                new TpSetting(449, 449, "特大発動艇+一式砲戦車", 8),
                new TpSetting(355, 355, "M4A1 DD", 8),
                new TpSetting(436, 436, "大発動艇(II号戦車/北アフリカ仕様)", 8),
                new TpSetting(482, 482, "特大発動艇+Ⅲ号戦車(北アフリカ仕様)", 8),
                new TpSetting(408, 408, "装甲艇(AB艇)", 8),
                new TpSetting(409, 409, "武装大発", 8),
                new TpSetting(494, 494, "特大発動艇+チハ", 8),
                new TpSetting(495, 495, "特大発動艇+チハ改", 8),
                new TpSetting(514, 514, "特大発動艇+Ⅲ号戦車J型", 8),
                new TpSetting(167, 167, "特二式内火艇", 2),
                new TpSetting(525, 525, "特四式内火艇", 2),
                new TpSetting(526, 526, "特四式内火艇改", 2),
